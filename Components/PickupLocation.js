...
import { View, Image, TouchableOpacity, StyleSheet, Text, ToastAndroid, StatusBar } from 'react-native'
                  ...
                  <View style={{ flex: 1 }}>
                        ...
                        <View style={{ top: '90%', bottom: '0%', marginHorizontal: 30, position: "absolute" }}>
                              <LinearGradient colors={['#32CD32', '#00FF00']} style={styles.button}>
                                    <TouchableOpacity
                                          style={{ zIndex: 1000 }}
                                          onPress={() => {this.props.navigation.navigate("Drop",{CurrentLocation:this.state.CurrentLocation});}}>
